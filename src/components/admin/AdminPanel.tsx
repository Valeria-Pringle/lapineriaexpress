    ...
    <div className="max-w-7xl mx-auto px-2 md:px-4 py-2 md:py-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg border border-zinc-200/80 shadow-sm p-6 space-y-6">
              {/* Datos del Cliente */}
              <div>
              ...
              <div className="border-t border-zinc-200/80 pt-4 mt-4">
                <h3 className="text-lg font-bold mb-4 text-primary">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg border border-zinc-200/80 shadow-sm p-6">
              ...
              {items.length === 0 ? (
                ...
                <div className="space-y-3">
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {items.map((item) => {
                          ...
                          return (
                            <tr key={item.id} className="border-b border-zinc-200/80 hover:bg-background">
                  ...
                  {/* Total */}
                  <div className="pt-4 border-t-2 border-zinc-200 bg-cyan-50 p-4 rounded-lg">
        ...
        {items.length > 0 && (
          <div className="mt-8 bg-white rounded-lg border border-zinc-200/80 shadow-sm p-6">
            ...
            <div className="mb-6">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-primary border-zinc-300 rounded focus:ring-2 focus:ring-primary"
                />
            ...
            <button
              ...
              className="bg-primary hover:bg-primary-dark text-white font-bold py-3 px-8 rounded-lg transition text-lg"
            >
